RestoreOverlayIcons 3.0.0.1

With this program you are able to set the order of Overlay Icons in windows with one click.
Problem: Windows supports only up to 15 Overlay Icons in Explorer. Programs as OneDrive
